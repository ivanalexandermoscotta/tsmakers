...
class MusicSpecifierSequence(object):
    ...
    def __call__(
        ...
        timespan_specifier = timespan_specifier or \
            timespantools.TimespanSpecifier()
        seed = seed or 0
        ...
        for i, offset_pair in enumerate(iterator):
            ...
            timespan = timespantools.PerformedTimespan(
        ...
        if padding:
            ...
            for shard in timespans.partition(True):
                silent_timespan_one = timespantools.SilentTimespan(
                    layer=layer,
                ...
                silent_timespan_two = timespantools.SilentTimespan(
                    layer=layer,
