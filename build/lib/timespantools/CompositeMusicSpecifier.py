...
class CompositeMusicSpecifier(timespantools.HashCachingObject):
    ...
    def __init__(
        ...
        timespantools.HashCachingObject.__init__(self)
        prototype = timespantools.MusicSpecifierSequence
        ...
        if not isinstance(primary_music_specifier, prototype):
            primary_music_specifier = timespantools.MusicSpecifierSequence(
        ...
        if not isinstance(secondary_music_specifier, prototype):
            secondary_music_specifier = timespantools.MusicSpecifierSequence(
